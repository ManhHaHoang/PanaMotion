...
********************************************** */
    ...
    PANEL.showChat = function() {
        ...
        if ( typeof Intercom !== 'undefined' ) {
            ...
            if ( !$('html').hasClass('ic-loaded') ) {
                ...
                if ( ! $container.length ) {
                    ...
                    Intercom('onShow', function(){
                        if ( !$('html').hasClass('ic-loaded') ) {
                            setTimeout(function(){
                                $container = $('#intercom-container').addClass('intercom-loaded');
                                $iframe_launcher = $('iframe.intercom-launcher-frame');
                                var $balloon = $iframe_launcher.contents().find('.intercom-launcher > div:not(:last-child)').remove();
                                $iframe_launcher.removeClass('closed-panel-chat');
                                Intercom('hide');
                            }, 500);
                        }
                    });
            ...
            Intercom('onHide', function(){
                $iframe_launcher = $('iframe.intercom-launcher-frame');
                $iframe_launcher.addClass('closed-panel-chat');
            });
